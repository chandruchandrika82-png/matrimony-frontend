...
function Profiles() {
  ...
  return <main className="directory-page"><div className="directory-shell">
    <header className="directory-header"><div><p className="directory-kicker">Member directory</p><h1>Discover compatible profiles</h1><p>Refine your search across Namakkal and Tamil Nadu.</p></div><button className="directory-primary" onClick={() => navigate("/my-profile")}>Complete my profile</button></header>
